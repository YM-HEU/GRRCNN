...
class FGFMH(nn.Module):
    def __init__(self, in_channel, out_channel=256):
        super(FGFMH, self).__init__()
        ...
        self.atrous_block6 = nn.Sequential(
            nn.Conv2d(256, self.in_channel, kernel_size=1, stride=1, padding=0),
    ...
    def forward(self, x):
        ...
        x = x+atrous_block6+atrous_block1
        atrous_block12 = self.atrous_block12(x)
        x = x + atrous_block12+atrous_block1+atrous_block6
